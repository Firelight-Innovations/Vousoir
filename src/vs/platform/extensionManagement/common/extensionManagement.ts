	...
	.registerConfiguration({
		...
		properties: {
			[AllowedExtensionsConfigKey]: {
				...
				type: 'object',
				markdownDescription: localize('extensions.allowed', "Specify a list of extensions that are allowed to use. This helps maintain a secure and consistent development environment by restricting the use of unauthorized extensions. For more information on how to configure this setting, please visit the Configure Allowed Extensions section."),
				default: '*',
				defaultSnippets: [{
					body: {},
				...
				policy: {
					...
					localization: {
						description: {
							...
							value: localize('extensions.allowed.policy', "Specify a list of extensions that are allowed to use. This helps maintain a secure and consistent development environment by restricting the use of unauthorized extensions."),
						}
					}
				},
