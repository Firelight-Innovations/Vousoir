...
function getTelemetryLevelSettingDescription(): string {
	...
	const externalLinksStatement = !product.privacyStatementUrl ?
		localize("telemetry.docsStatement", "Read more about the data we collect.") :
		localize("telemetry.docsAndPrivacyStatement", "Read more about the data we collect and our [privacy statement]({0}).", product.privacyStatementUrl);
