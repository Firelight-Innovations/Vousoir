...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic updates. The updates are fetched from an online service."),
			...
			policy: {
				...
				minimumVersion: '1.67',
				localization: {
					description: { key: 'updateMode', value: localize('updateMode', "Configure whether you receive automatic updates. The updates are fetched from an online service."), },
					enumDescriptions: [
						{
							key: 'none',
		...
		'update.enableWindowsBackgroundUpdates': {
			...
			description: localize('enableWindowsBackgroundUpdates', "Enable to download and install new Vousoir versions in the background."),
