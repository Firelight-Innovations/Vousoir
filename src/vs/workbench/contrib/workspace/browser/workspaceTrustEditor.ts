...
export class WorkspaceTrustEditor extends EditorPane {
	...
	private async render() {
		...
		const headerDescriptionActionsText = localize({ key: 'workspaceTrustEditorHeaderActions', comment: ['Please ensure the markdown link syntax is not broken up with whitespace [text block](link block)'] }, "[Configure your settings]({0}) or [learn more](https://github.com/Firelight-Innovations/Vousoir/blob/main/docs/workspace-trust.md).", `command:workbench.trust.configure`);
