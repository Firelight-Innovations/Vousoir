...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Vousoir in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Vousoir and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
