						...
						translations: {
							...
							items: {
								...
								properties: {
									id: {
										type: 'string',
										description: localize('vscode.extension.contributes.localizations.translations.id', "Id of Vousoir or Extension for which this translation is contributed to. Id of Vousoir is always `vscode` and of extension should be in format `publisherId.extensionName`."),
