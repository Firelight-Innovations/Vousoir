	...
	private registerCommands() {
					...
					notificationService.notify({
						...
						message:
							localize(
								...
								connectionInfo.tunnelName, connectionInfo.domain, linkToOpenForMarkdown, RemoteTunnelCommandIds.manage, RemoteTunnelCommandIds.configure, RemoteTunnelCommandIds.turnOff, remoteExtension.friendlyName, 'https://github.com/Firelight-Innovations/Vousoir'
							),
						actions: {
							primary: [
		...
		this._register(registerAction2(class extends Action2 {
			...
			async run(accessor: ServicesAccessor) {
				...
				await openerService.open('https://github.com/Firelight-Innovations/Vousoir');
			}
		}));
	}
