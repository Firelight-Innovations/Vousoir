...
class EmptyTextEditorHintContentWidget extends Disposable implements IContentWidget {
	...
	private getHint() {
		...
		const ariaLabel = localize('defaultHintAriaLabel', 'Execute {0} to select a language and get started. Start typing to dismiss.', languageKeybindingLabel);
