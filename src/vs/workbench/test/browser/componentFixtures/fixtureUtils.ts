...
// Fixtures that wrap content in `.part.auxiliarybar` rely on these rules to
// recolor inline editors with `--vscode-sideBar-background`.
...
export function registerWorkbenchServices(registration: ServiceRegistration): void {
	...
	// Workspace trust stubs so fixtures that read workspace trust can
	// instantiate. Reports the workspace as trusted.
