...
This extension shows reference search results as separate view, just like search results. It complements the peek view presentation that is also built into Vousoir. The following features are available:
...
**Note** that this extension is bundled with Vousoir version 1.29 and later - it doesn't need to be installed anymore.
...
This extension ships with Vousoir and uses its issue tracker. Please file issue here: https://github.com/Microsoft/vscode/issues
